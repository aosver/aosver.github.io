...
<!--titulo de arriba-->
<title>Pendientes - Programación Alternativa</title>
<!--titulo de arriba-->
<style type="text/css">
body {
  padding: 0px;
...
$sql = "SELECT CONCAT(tp.apellidos, ' ', tp.nombre) as nombre, tl.titulo, tpr.fecha FROM tpersonas as tp, tlibros as tl, tprestamos as tpr
WHERE tpr.estado = 1 AND tpr.fecha BETWEEN '$fini' AND '$ffin'AND  tp.id = tpr.idPersona AND tl.id = tpr.idLibro"; 
...
No hay prestamos no entregados en las fechas establecidas.
</center>
<?php
}else{
